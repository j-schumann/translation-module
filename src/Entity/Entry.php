 ...
 *
 * @ORM\Entity
 * @ORM\Table(name="translation_entries")
 * @ORM\Entity(repositoryClass="TranslationModule\Entity\EntryRepository")
 */
...
// <editor-fold defaultstate="collapsed" desc="module">
    /**
     * @var Module
     * @ORM\ManyToOne(targetEntity="Module", inversedBy="entries")
...
// <editor-fold defaultstate="collapsed" desc="translations">
    /**
     * @ORM\OneToMany(targetEntity="Translation", mappedBy="entry", cascade={"persist", "remove"})
     */
